/* Project Paros — two-scene invite */
:root{
  --ivory:#FBF8F4;
  --stone:#E7E2DA;
  --soft-blush:#F3D8DC;
...
.invite.invite-ready .scene-closed{
  opacity:0;
  transform:translate(-50%,-49%) scale(.72);
  filter:blur(5px);
}
...
.hero-monogram{width:270px;height:210px;margin-bottom:var(--s3)}
...
@media(max-height:780px){
  .invite-art{height:74svh;width:min(620px,84vw);margin-top:-6svh}
  .gate-form{bottom:2svh}
}
@media(max-width:760px){
  .invite-bg{object-position:center top}
  .invite-art{width:94vw;height:min(650px,72svh);margin-top:-4svh}
  ...
  .hero{min-height:78vh}.hero-panel{padding:var(--s4) var(--s3)}.hero-monogram{width:210px;height:165px}.countdown{gap:10px}.countdown div{min-width:48px}.countdown strong{font-size:28px}.countdown i{height:32px}
